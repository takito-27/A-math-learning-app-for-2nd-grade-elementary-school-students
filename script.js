...
const unitData = [
...

    {
        ...
        problems: [
            {
                type: "problem",
                text: "11×2を、ならった九九をつかってもとめましょう。",
                hint: "11を2つの数にわけよう。それぞれの数に2をかけて、2つの答えをたそう。",
                style: "split-multiplication",

                optionsTitle: "1. 11を2つの数にわけてみよう",
            ...
            {
                type: "problem",
                text: "12×3を、ならった九九をつかってもとめましょう。",
                hint: "12を2つの数にわけよう。それぞれの数に3をかけて、2つの答えをたそう。",
                style: "split-multiplication",

                optionsTitle: "1. 12を2つの数にわけてみよう",
            ...
            {
                type: "problem",
                text: "13×4を、ならった九九をつかってもとめましょう。",
                hint: "13を2つの数にわけよう。それぞれの数に4をかけて、2つの答えをたそう。",
                style: "split-multiplication",

                optionsTitle: "1. 13を2つの数にわけてみよう",
            ...
            {
                type: "problem",
                text: "14×5を、ならった九九をつかってもとめましょう。",
                hint: "14を2つの数にわけよう。それぞれの数に5をかけて、2つの答えをたそう。",
                style: "split-multiplication",

                optionsTitle: "1. 14を2つの数にわけてみよう",
            ...
            {
                type: "problem",
                text: "15×2を、ならった九九をつかってもとめましょう。",
                hint: "15を2つの数にわけよう。それぞれの数に2をかけて、2つの答えをたそう。",
            style: "split-multiplication",

            optionsTitle: "1. 15を2つの数にわけてみよう",
        ...
        {
            type: "problem",
            text: "16×4を、ならった九九をつかってもとめましょう。",
            hint: "16を2つの数にわけよう。それぞれの数に4をかけて、2つの答えをたそう。",
            style: "split-multiplication",

            optionsTitle: "1. 16を2つの数にわけてみよう",
        ...
        {
            type: "problem",
            text: "17×5を、ならった九九をつかってもとめましょう。",
            hint: "17を2つの数にわけよう。それぞれの数に5をかけて、2つの答えをたそう。",
            style: "split-multiplication",

            optionsTitle: "1. 17を2つの数にわけてみよう",
    ...
    function updateDisplay() {
        ...
        if (data.type === "cover") {
            ...
            // 画面を初期化
            document.getElementById("formula-section-container").style.display = "block";
            ...
            const nextButton = document.getElementById("next-btn");
                ...
                if (currentProblem >= unit.problems.length - 1) {
    ...
    function showSplitProblem(data){
        ...
        instructionEl.innerHTML = `
            <strong>2. わけた2つの数を計算しよう</strong>
            <div style="margin-top:8px; line-height:1.8;">
                ① わけた1つ目の数に、もとの式のかける数をかけよう。<br>
                ② わけた2つ目の数にも、同じ数をかけよう。<br>
                ③ 2つのかけ算の答えをたそう。
            </div>
        `;
    ...
    function showGridTableProblem(data){
        document.getElementById("formula-section-container").style.display = "none";
        document.getElementById('options-section').style.display = "block";
...
// 背景をクリックしたら閉じる
function closeHintFromBackground(event) {

    if (event.target.id === "hint-modal") {
        closeHint();
    }
    ...
    function openKeypad(id, isGridTable = false) {
        ...
        problemScreen.classList.add('keypad-open');
        inputEl.focus();
        ...
        if (!isGridTable) {
            setTimeout(() => {
                ...
                // 入力欄の下端を、テンキー上端より40px上に表示する
                const safeBottom = keypadRect.top - 40;

                if (inputRect.bottom > safeBottom) {
                    const moveAmount = inputRect.bottom - safeBottom;
    ...
    function pressKey(key) {
        ...
        if (key === 'backspace') {
            ...
            document.getElementById('custom-keypad').style.display = "none";
            document.getElementById('problem-screen').classList.remove('keypad-open');
            inputEl.blur();
            activeInputId = null;
        } else {
    ...
    document.addEventListener('pointerdown', function (event) {
        ...
        // テンキー内、または入力欄をタップした場合は閉じない
        if (
            keypad.contains(event.target) ||
            event.target.matches('input[inputmode="none"]')
        ) {
            return;
        }
    ...
    function checkAnswer() {
        ...
        if (data.style === "split-multiplication" && !selectedId) { 
            res.innerText = "図をえらんでね！"; 
...
function checkSplitAnswer(data){
    ...
    const expectedTotal = expected[2] + expected[5];
    let addCorrect =
        (
            (v6 === v2 && v7 === v5) ||
            (v6 === v5 && v7 === v2)
        ) &&
        Number(vAns) === expectedTotal;
